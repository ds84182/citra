...
static void WritePicaReg(u32 id, u32 value, u32 mask) {
    ...
    switch(id) {
        ...
        case PICA_REG_INDEX(gs.bool_uniforms):
            for (unsigned i = 0; i < 16; ++i)
                g_state.gs.uniforms.b[i] = (regs.gs.bool_uniforms.Value() & (1 << i)) != 0;
        ...
        {
            auto& uniform_setup = regs.gs.uniform_setup;
            ...
            if ((float_regs_counter >= 4 && uniform_setup.IsFloat32()) ||
                ...
                auto& uniform = g_state.gs.uniforms.f[uniform_setup.index];
        ...
        {
            g_state.gs.program_code[regs.gs.program.offset] = value;
            regs.gs.program.offset++;
            break;
        }
        ...
        {
            g_state.gs.swizzle_data[regs.gs.swizzle_patterns.offset] = value;
            regs.gs.swizzle_patterns.offset++;
            break;
        }
